...
test('invalid image', async t => {
    const page = await exploreWebPage('https://www.championat.com/football/news-3677867-otkryt-nabor-komand-na-sportivno-futbolnuju-viktorinu-chempionata.html', 'ru');
